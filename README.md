...
2. Make sure to add a profile picture and your full name, since this will help me learn your name. The username you choose for GitHub does not need to be (or include) your name. If you have a handle you already use (for Twitter, IM, IRC, etc.) feel free to use that.
3. Email me (jason.perry@theironyard.com) the username you choose so that I can get you added to the group we'll be using for class.
